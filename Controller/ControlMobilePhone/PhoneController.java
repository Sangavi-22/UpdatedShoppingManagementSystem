...
public class PhoneController implements PhoneControllerService{
    ...
    public void setPhone(String modelName, String manufacturerName,String width, String height,String weight, String displaySize, String batteryCapacity, String primaryCamera, String secondaryCamera, String operatingSystem, String processorType, String storageCapacity, int price){
        ...
        PhoneStorageCapacity phoneStorageCapacity=new PhoneStorageCapacity(storageCapacity);
        phone=new Phone(phoneSpecifications,phoneManufacturer,phoneDimensions,phoneCamera,phoneProcessor,phoneStorageCapacity);
    }
    public void addPhoneToDataSource(){
        ...
        dataSource.addPhoneStorageCapacity(phoneId,phone.getPhoneStorageCapacity());
    }
    public Phone getPhone(int phoneId){
        ...
        PhoneStorageCapacity phoneStorageCapacity=dataSource.getParticularPhoneWithStorageCapacity(phoneId);
        phone=new Phone(phoneSpecifications,phoneManufacturer,phoneDimensions,phoneCamera,phoneProcessor,phoneStorageCapacity);
        return phone;
    }
    ...
    public String getStorageCapacity(){
        return phone.getPhoneStorageCapacity().getStorageCapacity();
    }
    ...
    public void printBasicInfo(){
        printPhoneInfoView.printPhoneBasicInfo(getPhoneId(),phone.getPhoneSpecifications().getModelName(),phone.getPhoneStorageCapacity().getStorageCapacity(),phone.getPhoneSpecifications().getPrice());
    }
    public void updateView(){
        ...
        PhoneStorageCapacity phoneStorageCapacity=phone.getPhoneStorageCapacity();
        printPhoneInfoView.printPhoneDetails(getPhoneId(),phoneSpecifications.getModelName(),phoneManufacturer.getManufacturerName(),phoneDimensions.getWidth(),phoneDimensions.getHeight(),phoneDimensions.getWeight(),
                phoneSpecifications.getDisplaySize(),phoneSpecifications.getBatteryCapacity(),phoneCamera.getPrimaryCamera(),phoneCamera.getSecondaryCamera(),phoneProcessor.getOperatingSystem(),phoneProcessor.getProcessorType(),phoneStorageCapacity.getStorageCapacity(),phoneSpecifications.getPrice());
    }
