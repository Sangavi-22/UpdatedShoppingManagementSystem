...
public class DataSource implements DataSourceService {
    ...
    public void addPhoneSpecifications(int phoneId, PhoneSpecifications phoneSpecifications){
        phoneSpecificationsFile.writePhoneSpecifications(phoneId,phoneSpecifications.getModelName(),phoneSpecifications.getBatteryCapacity(),phoneSpecifications.getDisplaySize(),phoneSpecifications.getStorageCapacity(),phoneSpecifications.getPrice());
    ...
    public ArrayList<Integer>searchFromPhoneDetails(String input) {
        ...
        for(int id: getPhoneDetails().keySet()) {
            ...
            else if(getPhoneDetails().get(id).getStorageCapacity().contains(input)) {
                ids.add(id);
            }
        }
        return ids;
