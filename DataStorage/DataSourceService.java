...
public interface DataSourceService {
    ...
    void addPhoneStorageCapacity(int phoneId, PhoneStorageCapacity phoneStorageCapacityModel);
    ArrayList<Integer>searchFromPhoneStorageCapacity(String input);
    PhoneStorageCapacity getParticularPhoneWithStorageCapacity(int phoneId);
    HashMap<Integer,PhoneStorageCapacity>getPhoneStorageCapacityDetails();
