...
public class PhoneSpecificationsFileHandler implements PhoneSpecificationsFileHandlerService{
    ...
    public void writePhoneSpecifications(int productId, String modelName, String batteryCapacity, String displaySize,String storageCapacity,int price){
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter(PhoneSpecifications,true));
            bw.write(productId+"|"+modelName+"|"+batteryCapacity+"|"+displaySize+"|"+storageCapacity+"|"+price+ System.getProperty("line.separator"));
            bw.flush();
            bw.close();
        }
        catch(IOException e) {
    ...
    public HashMap<Integer, PhoneSpecifications> readPhoneSpecifications(){
        ...
        try{
            ...
            while(br.ready()){
                ...
                String storageCapacity=words[4];
